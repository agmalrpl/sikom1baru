        ...
        <div class="container-fluid main-container">
            <div class="main-header-left ">
                ...
                <div class="responsive-logo">
                    <a href="/" class="header-logo"><img src="{{asset('assets')}}back/img/brand/logo.png" class="logo-11"></a>
                    <a href="/" class="header-logo"><img src="{{asset('assets')}}back/img/brand/logo-white.png" class="logo-1"></a>
                </div>
                    ...
                    <div class="main-header-right">
                        ...
                        <div class="nav nav-item  navbar-nav-right mg-lg-s-auto">
                            ...
                            <div class="dropdown main-profile-menu nav nav-item nav-link">
                                <a class="profile-user d-flex" href=""><img src="{{asset('assets')}}back/img/faces/6.jpg" alt="user-img" class="rounded-circle mCS_img_loaded"><span></span></a>

                                <div class="dropdown-menu">
                                    <div class="main-header-profile header-img">
                                        <div class="main-img-user"><img alt="" src="{{asset('assets')}}back/img/faces/6.jpg"></div>
                                    ...
                                    <form method="POST" action=">
                                        ...
                                        <div class=" row mb-3 px-3 "> 
                                            <button type="submit" class="dropdown-item" href = "{{ route('logout') }}"><i class="fas fa-sign-out-alt"></i> Sign Out</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
