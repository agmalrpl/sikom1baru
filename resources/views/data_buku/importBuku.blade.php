<!-- Modal effects -->
<div class="modal fade effect-scale" id="ImportBuku" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" id="area_formImport" role="document">
        <div class="modal-content modal-content-demo">
        <form id="formImport" action="{{ route('import-excel-buku') }}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                            ...
                            <span class="alert-inner--text"><strong>Catatan!</strong><br> sistem akan mereplace data jika menginputkan judul yang sama dengan data yang sudah tersimpan di aplikasi.</span>
